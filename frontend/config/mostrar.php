        ...
        <?php foreach($data as $d):?>
                                <form class="form-horizontal form-material mx-2" enctype="multipart/form-data" method="POST"  autocomplete="off">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-12">RUC<span class="text-danger">*</span></label>
                                        <div class="col-md-12">
                                            <input type="text" name="txtruccg" maxlength="16" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" value="<?php echo $d->rucm ?>"  required placeholder="ejm: merlin"
                                                class="form-control form-control-line">
                                                <input type="hidden" name="settid" value="<?php echo $d->idstn ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="txtnomcg" value="<?php echo $d->namstn ?>"  required placeholder="ejm: merlin"
                                                class="form-control form-control-line">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-12">Direccion 1<span class="text-danger">*</span></label>
                                        <div class="col-md-12">
                                            <input type="text" name="txtdircg" value="<?php echo $d->direc1 ?>"  required placeholder="ejm: merlin"
                                                class="form-control form-control-line">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="col-md-12">Direccion 2<span class="text-danger">*</span></label>
                                        <div class="col-md-12">
                                            <input type="text" name="txtdireccg" value="<?php echo $d->direc2 ?>"  required placeholder="Nombre"
                                                class="form-control form-control-line">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="col-md-12">Telefono<span class="text-danger">*</span></label>
                                        <div class="col-md-12">
                                            <input type="text" maxlength="9" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" name="txttelcg" value="<?php echo $d->telstn ?>"  required placeholder="Nombre"
                                                class="form-control form-control-line">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <button name='stupdsetn' class="btn btn-success text-white">Actualizar</button>
                                           
                                            <a class="btn btn-danger text-white" href="../config/mostrar.php">Cancelar</a>
                                        </div>
                                    </div>
                                </form>
                                <?php endforeach; ?>
...
<form class="form-horizontal form-material mx-2" enctype="multipart/form-data" method="POST"  autocomplete="off">
          <div class="form-group">
                ...
                <input type="hidden" name="confid" value="<?php echo $e->idstn ?>">
                 <img id="blah" src="../../backend/img/subidas/<?php echo $e->foto; ?>" width="100" heigth="100" alt="your image" style="max-width:90px;" />
                    </div>
            </div>

            <div class="form-group">
                <div class="col-sm-12">
                    <button name='stupdftconfg' class="btn btn-success text-white">Actualizar</button>
                    <a class="btn btn-danger text-white" href="../config/mostrar.php">Cancelar</a>
                </div>
            </div>
</form>
...
<div class="alert alert-warning" style="position: relative;
   ...
   <script src="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/2.1.2/sweetalert.min.js"></script>
    <?php
    include_once '../../backend/php/upd_stconfi.php'
?>

<?php
    include_once '../../backend/php/upd_stftconfi.php'
?>
