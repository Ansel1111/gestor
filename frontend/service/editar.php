                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="../service/mostrar.php">Servicios</a></li>
...
<div class="alert alert-warning" style="position: relative;
 ...
 $id = $_GET['id'];
 $sentencia = $connect->prepare("SELECT service.idserv, suscrp.idsus, suscrp.noms, suscrp.descr, suscrp.foto, service.nameserv, service.prec, service.cont, service.state FROM service INNER JOIN suscrp ON service.idsus = suscrp.idsus  WHERE service.idserv= '$id';");
 $sentencia->execute();
        ...
        <?php foreach($data as $d):?>
                            <div class="card-body">
                                <form class="form-horizontal form-material mx-2" enctype="multipart/form-data" method="POST"  autocomplete="off">
                                    <div class="form-group">
                                        <label class="col-sm-12">Producto<span class="text-danger">*</span></label>
                                        <div class="col-sm-12">
                                            <select name="txtprod" required  class="form-select shadow-none form-control-line">
                                                <option value="<?php echo $d->idsus ?>"><?php echo $d->noms ?></option>
                ...
                while($row=$stmt->fetch(PDO::FETCH_ASSOC))
             {
                ...
                ?>
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-12">Servicio<span class="text-danger">*</span></label>
                                        <div class="col-md-12">
                                            <input type="text" name="txtnoms" value="<?php echo $d->nameserv ?>" required placeholder="ejm: familiar"
                                                class="form-control form-control-line">
                                                <input type="hidden" name="servid" value="<?php echo $d->idserv ?>">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="col-md-12">Precio<span class="text-danger">*</span></label>
                                        <div class="col-md-12">
                                            <input type="text" value="<?php echo $d->prec ?>" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" name="txtpre" required placeholder="ejm: 10.00"
                                                class="form-control form-control-line">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="col-sm-12">Dispositivos<span class="text-danger">*</span></label>
                                        <div class="col-sm-12">
                                            <select name="txtdis" class="form-select shadow-none form-control-line">
                                              <option value="<?php echo $d->cont ?>"><?php echo $d->cont ?></option>
                                              <option>---------Seleccione----------------</option>
                                              <option value="1 dispositivo">1 dispositivo</option>
                                              <option value="2 dispositivos">2 dispositivos</option>
                                              <option value="3 dispositivos">3 dispositivos</option>
                                              <option value="4 dispositivos">4 dispositivos</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <button name='staupdserv' class="btn btn-success text-white">Actualizar</button>
                                            
                                            <a class="btn btn-danger text-white" href="../service/mostrar.php">Cancelar</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
...
<div class="alert alert-warning" style="position: relative;
   ...
   <script src="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/2.1.2/sweetalert.min.js"></script>
    <?php
    include_once '../../backend/php/upd_stservic.php'
?>
