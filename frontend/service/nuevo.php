...
<div class="alert alert-warning" style="position: relative;
                            ...
                            <div class="card-body">
                                <form class="form-horizontal form-material mx-2" enctype="multipart/form-data" method="POST"  autocomplete="off">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <select name="txtprod" required id="prodc" class="form-select shadow-none form-control-line">
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="txtnoms" required placeholder="ejm: familiar"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" name="txtpre" required placeholder="ejm: 10.00"
                                                class="form-control form-control-line">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <select name="txtsta" class="form-select shadow-none form-control-line">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <button name='staddserv' class="btn btn-success text-white">Agregar</button>
                                            <button onclick="location.href='mostrar.php'" class="btn btn-danger text-white">Cancelar</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
   ...
   <script src="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/2.1.2/sweetalert.min.js"></script>
    <?php
    include_once '../../backend/php/add_stserv.php'
?>

<script type="text/javascript" src="../../backend/js/proct.js"></script>
