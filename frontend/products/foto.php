  ...
  while($r = $sentencia->fetchObject()){
   ...
   <?php if(count($data)>0):?>
        <?php foreach($data as $d):?>
                 ...
                 <img id="blah" src="../../backend/img/subidas/<?php echo $d->foto; ?>" width="100" heigth="100" alt="your image" style="max-width:90px;" />
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <button name='stupdftpt' class="btn btn-success text-white">Actualizar</button>
...
<div class="alert alert-warning" style="position: relative;
   ...
   <script src="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/2.1.2/sweetalert.min.js"></script>
    <?php
    include_once '../../backend/php/upd_stftproduct.php'
?>
