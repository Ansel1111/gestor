                            ...
                            <div class="card-body">
                                <form class="form-horizontal form-material mx-2" enctype="multipart/form-data" method="POST"  autocomplete="off">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-12">¿Esta seguro de borrar el registro?</label>
                                        <div class="col-sm-12">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <button name='stdeltftpt' class="btn btn-success text-white">Eliminar</button>
...
<div class="alert alert-warning" style="position: relative;
   ...
   <script src="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/2.1.2/sweetalert.min.js"></script>
    <?php
    include_once '../../backend/php/delt_stftproduct.php'
?>
