                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="../products/mostrar.php">Productos</a></li>
...
<div class="alert alert-warning" style="position: relative;
    ...
    <?php endif; ?>
                <!-- Column -->
                            ...
                            <div class="card-body">
                                <form class="form-horizontal form-material mx-2" enctype="multipart/form-data" method="POST"  autocomplete="off">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="txtnoms" required placeholder="ejm: netflix"
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-12">Descripción<span class="text-danger">*</span></label>
                                        <div class="col-md-12">
                                            <textarea rows="5" name="txtdesc" required class="form-control form-control-line"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-12">Estado<span class="text-danger">*</span></label>
                                        <div class="col-sm-12">
                                            <select name="txtstat" class="form-select shadow-none form-control-line">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-12">Foto<span class="text-danger">*</span></label>
                                        <div class="col-sm-12">
                 ...
                 <img id="blah" src="../../backend/img/noimage.png" width="100" heigth="100" alt="your image" style="max-width:90px;" />
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <button name='staddpt' class="btn btn-success text-white">Agregar</button>
   ...
   <script src="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/2.1.2/sweetalert.min.js"></script>
    <?php
    include_once '../../backend/php/add_stproduct.php'
?>
    <script>
