...
<div class="alert alert-warning" style="position: relative;
 ...
 $id = $_GET['id'];
 $sentencia = $connect->prepare("SELECT * FROM suscrp  WHERE idsus= '$id';");
 $sentencia->execute();
                            ...
                            <div class="card-body">
                                <form class="form-horizontal form-material mx-2" enctype="multipart/form-data" method="POST"  autocomplete="off">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="txtnoms" value="<?php echo $d->noms ?>" required placeholder="ejm: netflix"
                                                class="form-control form-control-line">
                                                <input type="hidden" name="susid" value="<?php echo $d->idsus ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <textarea rows="5" name="txtdesc"  value="<?php echo $d->descr ?>" required class="form-control form-control-line"><?php echo $d->descr ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <button name='stupdpt' class="btn btn-success text-white">Actualizar</button>
                                           
                                            <a class="btn btn-danger text-white" href="../products/mostrar.php">Cancelar</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
...
<div class="alert alert-warning" style="position: relative;
   ...
   <script src="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/2.1.2/sweetalert.min.js"></script>
    <?php
    include_once '../../backend/php/upd_stproduct.php'
?>
