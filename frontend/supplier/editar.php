                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="../supplier/mostrar.php">Proveedores</a></li>
...
<div class="alert alert-warning" style="position: relative;
 ...
 $id = $_GET['id'];
 $sentencia = $connect->prepare("SELECT * FROM supplier  WHERE idsup= '$id';");
 $sentencia->execute();
                            ...
                            <div class="card-body">
                                <form class="form-horizontal form-material mx-2" enctype="multipart/form-data" method="POST"  autocomplete="off">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text"  maxlength="14" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" value="<?php echo $d->rucsup ?>" name="txtrucs" required placeholder="ejm: merlin"
                                                class="form-control form-control-line">
                                                <input type="hidden" name="suppid" value="<?php echo $d->idsup ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" value="<?php echo $d->namsup ?>" name="txtnmarc" required placeholder="ejm: rojas"
                                                class="form-control form-control-line">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="email" value="<?php echo $d->corrsup ?>" name="txtcorc" required placeholder="ejm: 989888787"
                                                class="form-control form-control-line">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <button name='stupdsupp' class="btn btn-success text-white">Actualizar</button>
                                           
                                            <a class="btn btn-danger text-white" href="../supplier/mostrar.php">Cancelar</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
...
<div class="alert alert-warning" style="position: relative;
   ...
   <script src="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/2.1.2/sweetalert.min.js"></script>
    <?php
    include_once '../../backend/php/upd_stsupp.php'
?>
