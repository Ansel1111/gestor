...
<div class="alert alert-warning" style="position: relative;
                            ...
                            <div class="card-body">
                                <form class="form-horizontal form-material mx-2" enctype="multipart/form-data" method="POST"  autocomplete="off">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" maxlength="14" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" name="txtrucpro" required placeholder="ejm: 10987676545435"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="txtnmarc" required placeholder="ejm: netflix"
                                                class="form-control form-control-line">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="email"  name="txtcorc" required placeholder="ejm: netflix@gmail.com"
                                                class="form-control form-control-line">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <select name="txtstatrc" class="form-select shadow-none form-control-line">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <button name='staddsupp' class="btn btn-success text-white">Agregar</button>
   ...
   <script src="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/2.1.2/sweetalert.min.js"></script>
    <?php
    include_once '../../backend/php/add_stsuppl.php'
?>
