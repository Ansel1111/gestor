                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-7">
                        <div class="text-end upgrade-btn">
                            <a href="../supplier/nuevo.php" class="btn btn-danger text-white"
...
$sentencia = $connect->prepare("SELECT * FROM supplier order by idsup DESC;");
 $sentencia->execute();
$data =  array();
if($sentencia){
  while($r = $sentencia->fetchObject()){
...
<table class="table" id="example">
  ...
  <tbody>
    ...
    <tr>
      <th scope="row" style="color: #3e5569;"><?php echo  $e->idsup; ?></th>
      
      <td style="color: #3e5569;"><?php echo  $e->rucsup; ?></td>
      <td style="color: #3e5569;"><?php echo  $e->namsup; ?></td>
      <td style="color: #3e5569;"><?php echo  $e->corrsup; ?></td>
   ...
   <td style="color: #3e5569;">
             ...
             <td style="color: #3e5569;">
                <span class="text-danger"><strong>inactiva</strong></span>      
             </td>  
           
          
     <?php  } ?>
     <td style="color: #3e5569;">
     <a href="../supplier/editar.php?id=<?php echo  $e->idsup; ?>" class="btn btn-warning text-white"
    ><i class='mdi mdi-pencil' data-toggle='tooltip' title='edit'></i></a> 

    <a href="../supplier/delete.php?id=<?php echo  $e->idsup; ?>" class="btn btn-danger text-white"
