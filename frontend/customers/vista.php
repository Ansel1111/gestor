                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Vista suscripcion cliente</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
...
GROUP_CONCAT(suscrp.idsus, '..', suscrp.noms, '..' SEPARATOR '__') AS suscrp FROM cust_serv INNER JOIN customer ON cust_serv.idcli= customer.idcli INNER JOIN service ON cust_serv.idserv = service.idserv INNER JOIN suscrp ON service.idsus = suscrp.idsus  WHERE customer.idcli= '$id' GROUP BY cust_serv.idcusser;");
 $sentencia->execute();
   ...
   <?php if(count($data)>0):?>
        <?php foreach($data as $d):?>
                            <div class="card-body">
                                <form class="form-horizontal form-material mx-2" enctype="multipart/form-data" method="POST"  autocomplete="off">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="email" readonly  name="txtcorrc" value="<?php echo $d->corr ?>" placeholder="ejm: rojas@gmail.com"
                                                class="form-control form-control-line">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text"  name="txtuser" value="<?php echo $d->usuario ?>" readonly placeholder="ejm: rojas01"
                                                class="form-control form-control-line">
                                        </div>
                                    </div>
                            ...
                            <?php foreach(explode("__", $d->suscrp) as $suscrpConcatenados){ 
                                ...
                                ?>
                                <input type="text" readonly  name="txtcorrc" value="<?php echo $d->nameserv ?> - <?php echo $suscrp[1] ?>" placeholder="ejm: rojas@gmail.com"
                                                class="form-control form-control-line">
                                <?php } ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="date" value="<?php echo $d->inicio ?>" name="txtinic" readonly 
                                                class="form-control form-control-line">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="date" value="<?php echo $d->fin ?>" id="fechad" name="txtfecv" readonly
                                                class="form-control form-control-line">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <select name="txtstatc" class="form-select shadow-none form-control-line">
