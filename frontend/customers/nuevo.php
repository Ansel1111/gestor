...
<div class="alert alert-warning" style="position: relative;
    ...
    <?php endif; ?>
                ...
                <!-- Column -->
                            ...
                            <div class="card-body">
                                <form class="form-horizontal form-material mx-2" enctype="multipart/form-data" method="POST"  autocomplete="off">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="txtnomc" required placeholder="ejm: merlin"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="txtapec" required placeholder="ejm: rojas"
                                                class="form-control form-control-line">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" maxlength="9" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" name="txtcelc" required placeholder="ejm: 989888787"
                                                class="form-control form-control-line">
                                        </div>
                                    </div>
                 ...
                 <img id="blah" src="../../backend/img/noimage.png" width="100" heigth="100" alt="your image" style="max-width:90px;" />
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <button name='staddct' class="btn btn-success text-white">Agregar</button>
   ...
   <script src="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/2.1.2/sweetalert.min.js"></script>
    <?php
    include_once '../../backend/php/add_stcusto.php'
?>
    <script>
