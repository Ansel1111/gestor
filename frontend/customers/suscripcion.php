                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Nueva suscripcion</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                <form class="form-horizontal form-material mx-2" enctype="multipart/form-data" method="POST"  autocomplete="off">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="email"  name="txtcorrc" required placeholder="ejm: rojas@gmail.com"
                                                class="form-control form-control-line">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text"  name="txtuser" required placeholder="ejm: rojas01"
                                                class="form-control form-control-line">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="password"  name="txtcontc" required placeholder="ejm:********"
                                                class="form-control form-control-line">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <select name="txtplanc" id="plan" class="form-select shadow-none form-control-line">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="date" id="fechad" name="txtfecv" required
                                                class="form-control form-control-line">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <button name='stupdplanct' class="btn btn-success text-white">Añadir</button>
...
<div class="alert alert-warning" style="position: relative;
   ...
   <script src="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/2.1.2/sweetalert.min.js"></script>
    <?php
    include_once '../../backend/php/upd_stplancusto.php'
?>

<script type="text/javascript" src="../../backend/js/plane.js"></script>
<script>
