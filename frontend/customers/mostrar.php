...
<head>
    ...
    <link href="../../backend/css/tab.css" rel="stylesheet">
...
<div class="alert alert-warning" style="position: relative;
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-7">
                        <div class="text-end upgrade-btn">
                            <a href="../customers/nuevo.php" class="btn btn-danger text-white"
    ...
    <div class="container-fluid">
        <div class="row row-cols-12 row-cols-md-12 text-center">
          <div class="col mb-12">
            <div class="tab">
  <button class="tablinks" onclick="openCity(event, 'Clientes')">Clientes</button>
  <button class="tablinks" onclick="openCity(event, 'Suscripcione')">Suscripciones</button>
  
</div>

<div id="Clientes" class="tabcontent">
  <h3>Listado de los clientes</h3>
  <?php
$sentencia = $connect->prepare("SELECT * FROM customer ORDER BY idcli DESC ;");
 $sentencia->execute();
$data =  array();
if($sentencia){
  while($r = $sentencia->fetchObject()){
...
<?php if(count($data)>0):?>
  ...
  <tbody>
    ...
    <tr>
      <th scope="row" style="color: #3e5569;"><?php echo  $d->idcli; ?></th>
      <td style="color: #3e5569;"><?php echo  $d->nomcli; ?></td>
      <td style="color: #3e5569;"><?php echo  $d->apecli; ?></td>
      <td style="color: #3e5569;"><?php echo  $d->tele; ?></td>
...
<td style="color: #3e5569;">
      <a href="../customers/vista.php?id=<?php echo  $d->idcli; ?>" class="btn btn-primary text-white"
    ><i class='mdi mdi-eye' data-toggle='tooltip' title='View'></i></a>

    <a href="../customers/editar.php?id=<?php echo  $d->idcli; ?>" class="btn btn-warning text-white"
    ><i class='mdi mdi-pencil' data-toggle='tooltip' title='edit'></i></a> 

    <a href="../customers/foto.php?id=<?php echo  $d->idcli; ?>" class="btn btn-secondary text-white"
    ><i class='mdi mdi-panorama' data-toggle='tooltip' title='edit'></i></a>  

    <a href="../customers/delete.php?id=<?php echo  $d->idcli; ?>" class="btn btn-danger text-white"
    ><i class='mdi mdi-close-circle' data-toggle='tooltip' title='delete'></i></a>
    ...
    <?php    if($d->rol ==2)  { ?> 
               ...
               <a href="../customers/suscripcion.php?id=<?php echo  $d->idcli; ?>" class="btn btn-dark text-white"
    ><i class='mdi mdi-bulletin-board' data-toggle='tooltip' title='subscription'></i></a>
...
<div id="Suscripcione" class="tabcontent">
  <h3>Listado de las suscripciones</h3>
...
<table class="table" id="example1">
  ...
  <tbody>
    ...
    <td style="color: #3e5569;">
          <a href="../customers/vista.php?id=<?php echo  $e->idcli; ?>" class="btn btn-primary text-white"
    ><i class='mdi mdi-eye' data-toggle='tooltip' title='View'></i></a>

    <a href="../suscription/delete.php?id=<?php echo  $e->idcusser; ?>" class="btn btn-danger text-white"
    ><i class='mdi mdi-close-circle' data-toggle='tooltip' title='delete'></i></a>

    <a href="../suscription/editar.php?id=<?php echo  $e->idcusser; ?>" class="btn btn-warning text-white"
    ><i class='mdi mdi-pencil' data-toggle='tooltip' title='edit'></i></a> 
    ...
    <a href="../suscription/alert.php?id=<?php echo  $e->idcusser; ?>" class="btn btn-secondary text-white"
    ><i class='mdi mdi-message' data-toggle='tooltip' title='alert'></i></a>  

    <a href="../suscription/password.php?id=<?php echo  $e->idcusser; ?>" class="btn btn-dark text-white"
    ><i class='mdi mdi-account-key' data-toggle='tooltip' title='password'></i></a>    
      </td>
