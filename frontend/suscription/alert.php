                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Mensaje suscripcion cliente</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                <form class="form-horizontal form-material mx-2" enctype="multipart/form-data" method="POST"  autocomplete="off">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-12">¿Esta seguro de enviarle un mensaje?</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" readonly value="<?php echo $d->nomcli ?>" name="txtnomc"  placeholder="ejm: merlin"
                                               ...
                                               <input type="hidden" name="cusemai" value="<?php echo $d->corr  ?>">
                                               <input type="hidden" name="cusfin" value="<?php echo $d->fin  ?>">
                                               <input type="hidden" name="mens" id="men" value="tiene una nueva suscripcion pendiente">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <button name='notification_custm' class="btn btn-success text-white">Enviar</button>
...
<div class="alert alert-warning">
 ...
 <?php
    include_once '../../backend/php/noti_custme.php'
?>
