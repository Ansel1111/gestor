                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Actualizar contraseña del cliente</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                <form class="form-horizontal form-material mx-2" enctype="multipart/form-data" method="POST"  autocomplete="off">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="password" required  name="txtpassw" placeholder="ejm:********"
                                                class="form-control form-control-line">
                                        </div>
                                    </div>
                                   ...
                                   <div class="form-group">
                                        <div class="col-sm-12">
                                            <button name='stupdcustpsd' class="btn btn-success text-white">Actualizar</button>
...
<div class="alert alert-warning">
 ...
 <?php
    include_once '../../backend/php/upd_stcuspsd.php'
?>
