                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Actualizar suscripcion cliente</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
        ...
        <?php foreach($data as $d):?>
                ...
                while($row=$stmt->fetch(PDO::FETCH_ASSOC))
             {
                ...
                ?>
                                   ...
                                   <div class="form-group">
                                        <div class="col-sm-12">
                                            <button name='stupdcustservct' class="btn btn-success text-white">Actualizar</button>
...
<div class="alert alert-warning">
 ...
 <?php
    include_once '../../backend/php/upd_stcustservc.php'
?>
    <script>
