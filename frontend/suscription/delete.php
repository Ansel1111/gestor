...
GROUP_CONCAT(suscrp.idsus, '..', suscrp.noms, '..', suscrp.foto, '..' SEPARATOR '__') AS suscrp FROM cust_serv INNER JOIN customer ON cust_serv.idcli= customer.idcli INNER JOIN service ON cust_serv.idserv = service.idserv INNER JOIN suscrp ON service.idsus = suscrp.idsus  WHERE idcusser= '$id';");
 $sentencia->execute();
                            ...
                            <div class="card-body">
                                <form class="form-horizontal form-material mx-2" enctype="multipart/form-data" method="POST"  autocomplete="off">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-12">¿Esta seguro de desactivar el registro?</label>
                                        <div class="col-sm-12">
                                           <input type="hidden" name="suscpid" value="<?php echo $d->idcusser ?>">
                                        </div>
                                    </div>
                                    
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <button name='stdeltsubs' class="btn btn-success text-white">Desactivar</button>
...
<div class="alert alert-warning" style="position: relative;
   ...
   <script src="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/2.1.2/sweetalert.min.js"></script>
    <?php
    include_once '../../backend/php/delt_stsubs.php'
?>
